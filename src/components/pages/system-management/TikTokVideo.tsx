  ...
  return (
    <div className='container mx-auto p-4 max-w-6xl space-y-6'>
      ...
      <Card className='p-0 overflow-hidden border-0 shadow-xl bg-card/60 backdrop-blur-md'>
        <div className='bg-gradient-to-r from-[#00f2fe] via-black to-[#fe0979] px-6 py-5 shadow-lg relative border-b'>
      ...
      {/* Progress DataTable Card - Reverted to Light Mode Standard */}
      {videoData.length > 0 && (
